...
export function ProjectSetupStep({ coreContext }: StepComponentProps) {
  ...
  const [projectName, setProjectNameLocal] = useState<string>(
    coreContext.flowData?.projectName || "",
  );
    ...
    <>
      <CardHeader className="text-center pb-6">
        ...
        <CardTitle className="text-2xl">
          Let&#39;s Name Your First Project
        </CardTitle>
        <p className="text-muted-foreground mt-2">
          Organize your project assets and keep everything tidy
        </p>
      </CardHeader>
      ...
      <div className="space-y-6">
        ...
        <div className="bg-muted/50 rounded-lg p-4">
          <p className="text-sm text-muted-foreground">
            💡 <strong>Tip:</strong> You can always create more projects later
            and organize your products however you like.
          </p>
        </div>
        ...
        <div className="text-center">
          <p className="text-xs text-muted-foreground">
            This will be your workspace for organizing products
          </p>
        </div>
      </div>
    </>
