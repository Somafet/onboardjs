    ...
    <>
      ...
      <div className="space-y-4">
        ...
        <p className="text-muted-foreground text-lg leading-relaxed">
          You&#39;re all set up and ready to create amazing product
          visualizations. Your journey to better conversions starts now!
        </p>
      </div>
      ...
      <div className="space-y-3">
        ...
        <p className="text-xs text-muted-foreground">
          Ready to create more magic? Let&#39;s dive in!
        </p>
      </div>
    </>
  );
