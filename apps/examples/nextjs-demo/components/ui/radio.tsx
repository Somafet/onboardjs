...
export function RadioGroup<TType = string>({
  className,
  ...props
}: { className?: string } & Omit<
  Headless.RadioGroupProps<"div", TType>,
  "as" | "className"
>) {
  return (
    <Headless.RadioGroup
...
const colors = {
  primary: [
    "[--radio-checked-bg:var(--color-primary)] [--radio-checked-border:var(--color-blue-600)]/90 [--radio-checked-indicator:var(--color-white)]",
    "dark:[--radio-checked-bg:var(--color-primary)] dark:[--radio-checked-border:var(--color-primary)]/80 dark:[--radio-checked-indicator:var(--color-white)]",
  ],
  "dark/zinc": [
