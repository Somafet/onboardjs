...
const ConditionalNameStep: React.FC<StepComponentProps<ConditionalNamePayload, AppOnboardingContext>> = ({
    payload,
}) => {
    ...
    return (
        <div className="space-y-8 animate-fade-left">
            <p>
                This step captures the user&apos;s name and type (individual or organization). The name will be used to
                personalize the onboarding experience and the type will conditionally determine the next steps in the
                flow.
            </p>
