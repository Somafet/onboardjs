...
const OrganisationStep: React.FC<StepComponentProps<unknown, AppOnboardingContext>> = () => {
    ...
    return (
        <div className="space-y-8 animate-fade-left">
            ...
            <div className="space-y-1">
                <Label htmlFor="org-name-input">What’s your organisation called? 🏢</Label>
                <Input
                    id="org-name-input"
                    type="text"
            ...
            <div className={twMerge('flex items-start gap-3 p-4 rounded-lg border border-muted bg-muted/50')}>
                <MailIcon className="size-8 mt-1 text-primary" />
                <div>
                    <p className="font-medium">
                        Whether you’re looking to use <span className="font-bold">OnboardJS</span> in your app, or want
                        to work with us, we’d love to hear from you!
                    </p>
                    <p>
