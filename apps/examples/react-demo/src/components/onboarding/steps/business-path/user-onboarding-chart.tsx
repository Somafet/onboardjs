...
import { Legend, Line, LineChart, ResponsiveContainer, type LegendPayload } from 'recharts'
...
export default function UserOnboardingChart({ className }: UserOnboardingChartProps) {
    const [hoveringDataKey, setHoveringDataKey] = useState<DataKey<unknown> | null>(null)
