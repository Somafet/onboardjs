...
const onboardingTypes = [
  {
    ...
    name: (
      <span>
        I want to <span className="font-bold italic">build</span> a custom
        onboarding flow.
      </span>
    ),
    icon: Code2Icon,
  ...
  },
  {
    ...
    name: (
      <span>
        I want to <span className="font-bold italic">optimize</span> our
        existing onboarding.
      </span>
    ),
    icon: RocketIcon,
            ...
            >
              ...
              <span className="flex items-center gap-4 text-sm">
                <div
                  className={clsx(
                    "rounded-sm p-2",
                    onboardingType.colors.iconBg,
                  )}
                >
                  <onboardingType.icon
                    className={clsx("size-4", onboardingType.colors.icon)}
                  />
                </div>
