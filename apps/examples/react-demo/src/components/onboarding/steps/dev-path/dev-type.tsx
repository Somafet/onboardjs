    ...
    return (
        <>
                        ...
                        return (
                            ...
                            >
                                ...
                                <span className="flex items-center gap-4 text-sm">
                                    <div className={clsx('rounded-sm p-2', devType.colors.iconBg)}>
                                        <devType.icon className={clsx('size-4', devType.colors.icon)} />
                                    </div>
            ...
            {state && state.context?.flowData?.devType ? (
                <p className="mt-4 text-sm text-gray-600">{devTypeTextMap[state!.context.flowData.devType]}</p>
            ) : null}
