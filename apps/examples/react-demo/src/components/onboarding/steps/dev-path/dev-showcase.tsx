  ...
  return (
    <>
      <h2 className="mt-4 text-lg leading-6 font-medium text-gray-900">
        This demo <span className="font-bold">ITSELF</span> is built with
        OnboardJS
      </h2>
      <p className="mt-1 text-sm text-gray-500 max-w-md">
        Let’s see how OnboardJS helps you build beautiful, custom onboarding
        experiences tailored to your users.
      </p>
