...
const EndStep: ComponentType<StepComponentProps> = lazy(async () => import('./steps/end-step'))

const DevImpl: ComponentType<StepComponentProps> = lazy(async () => import('./steps/dev-path/dev-impl'))
