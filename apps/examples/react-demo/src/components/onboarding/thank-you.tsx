        ...
        {isBuilder ? (
          <div className="mb-6 sm:mb-8">
            ...
            <ul className="mt-2 max-sm:max-w-md list-disc space-y-2 pl-5 text-sm text-gray-900">
              <li>
                <span className="font-semibold">Start building:</span> with
                OnboardJS and see how it can transform your onboarding
                experience.
                <br />
                <a
                  href="/docs"
              ...
              <li>
                <span className="font-semibold">Join our community:</span> to
          ...
          <div className="mb-6 sm:mb-8">
            <h2 className="text-lg leading-6 font-medium text-gray-900">
              🎉 Thank You for Exploring! Your Optimization Toolkit is On Its
              Way.
            </h2>

            <p className="mt-1 max-sm:max-w-md text-sm text-gray-500">
              We appreciate you taking the step to optimize your user
              experience!
            </p>
            ...
            <ul className="mt-2 max-sm:max-w-md list-disc space-y-2 pl-5 text-sm text-gray-900">
              <li>
                <span className="font-semibold">Drive growth:</span> This
                example isn’t just code; it’s a blueprint for improving
                conversion rates and user retention. The accompanying guide will
                show you how to apply these strategies to your product.
              </li>
              <li>
                <span className="font-semibold">Ready for a chat?</span> If
                you’re eager to discuss your specific onboarding challenges and
                how OnboardJS can help you achieve your growth goals, book a
                quick call with our team.
              </li>
            </ul>
