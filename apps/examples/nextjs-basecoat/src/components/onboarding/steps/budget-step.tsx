...
const Aside = () => (
  <div>
    <h3 className="text-lg font-semibold">
      Balance your week with Custom Work Budget
    </h3>
    <p className="text-muted mt-6">
      Define your work week by establishing a customized work budget. Decide on
      your work hours for weekdays and weekends, fostering a routine that
      maintains focus and promotes overall well-being.
    </p>
...
export default function BudgetStep({ coreContext }: StepComponentProps) {
  ...
  const workdayHours =
    coreContext.flowData.workdayHours === undefined
      ? 5
      : coreContext.flowData.workdayHours;
  const weekendHours =
    coreContext.flowData.weekendHours === undefined
      ? 5
      : coreContext.flowData.weekendHours;
      ...
      <div className="w-full mt-6 flex items-center justify-end max-w-[700px]">
        <div className="">
          <p className="font-semibold">
            {workdayHours * 5 + weekendHours * 2} hours / week
          </p>
        </div>
      </div>
    </StepLayout>
