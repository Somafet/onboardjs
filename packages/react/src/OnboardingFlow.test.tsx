...
describe('OnboardingFlow', () => {
    ...
    it('should render the first step by default', async () => {
        ...
        await waitFor(() => {
            ...
            expect(screen.getByText('Welcome to the onboarding flow!')).toBeInTheDocument()
        })
    })
    ...
    it('should render custom LoadingComponent', async () => {
        ...
        render(<OnboardingFlow {...defaultProps} LoadingComponent={LoadingComponent} />)
    ...
    it('should render custom EmptyStateComponent when no steps', async () => {
        const EmptyStateComponent = <div data-testid="custom-empty">No steps configured</div>

        render(<OnboardingFlow {...defaultProps} steps={[]} EmptyStateComponent={EmptyStateComponent} />)
    ...
    it('should render custom ErrorComponent on error', async () => {
        ...
        render(<OnboardingFlow {...defaultProps} ErrorComponent={ErrorComponent} />)
    ...
    it('should render with WrapperComponent', async () => {
        ...
        render(<OnboardingFlow {...defaultProps} WrapperComponent={WrapperComponent} />)
    ...
    it('should handle localStorage persistence', async () => {
        ...
        const { unmount } = render(<OnboardingFlow {...defaultProps} localStoragePersistence={persistenceConfig} />)
        ...
        render(<OnboardingFlow {...defaultProps} localStoragePersistence={persistenceConfig} />)
    ...
    it('should pass initial context to provider', async () => {
        ...
        render(<OnboardingFlow {...defaultProps} initialContext={initialContext} />)
    ...
    it('should handle multiple onboarding flows independently', async () => {
        ...
        await waitFor(() => {
            expect(container1.querySelector('[data-testid="information-step"]')).toBeInTheDocument()
            expect(container2.querySelector('[data-testid="information-step"]')).toBeInTheDocument()
        })
