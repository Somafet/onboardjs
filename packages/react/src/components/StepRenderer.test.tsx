...
describe('StepRenderer', () => {
    ...
    it('should render the current step using the step component registry', async () => {
        renderWithOnboardingProvider(<StepRenderer stepComponentRegistry={mockStepComponents} />)
    ...
    it('should show loading component when isLoading is true', async () => {
        ...
        renderWithOnboardingProvider(
            <StepRenderer stepComponentRegistry={mockStepComponents} LoadingComponent={LoadingComponent} />
        )
    ...
    it('should show empty state component when no current step', async () => {
        ...
        renderWithOnboardingProvider(
            <StepRenderer stepComponentRegistry={mockStepComponents} EmptyStateComponent={EmptyStateComponent} />,
            {
                onboardingConfig: {
    ...
    it('should show error component when there is an error', async () => {
        ...
        renderWithOnboardingProvider(
            <StepRenderer stepComponentRegistry={mockStepComponents} ErrorComponent={ErrorComponent} />
        )
    ...
    it('should handle missing step component gracefully', async () => {
        ...
        renderWithOnboardingProvider(<StepRenderer stepComponentRegistry={incompleteRegistry as any} />, {
            onboardingConfig: {
        ...
        await waitFor(() => {
            expect(screen.getByText(`Error: Component for step type "SINGLE_CHOICE" not found.`)).toBeInTheDocument()
        })
