...
export class FlowUtils {
   ...
   */
  static generatePersistenceKey(
    engine: OnboardingEngine<any>,
    baseKey: string = 'onboarding'
  ): string {
    const parts = [baseKey];
   ...
   */
  static areFlowsCompatible(
    engine1: OnboardingEngine<any>,
    engine2: OnboardingEngine<any>
  ): boolean {
