...
export class OperationQueue {
    ...
    async enqueue(operation: () => Promise<void>, priority: number = 0): Promise<void> {
    ...
    private async executeOperation(queuedOperation: QueuedOperation): Promise<void> {
    ...
    getStats(): {
        ...
        const oldestOperationAge = oldestOperation ? Date.now() - oldestOperation.createdAt : null
